...
import { loginSuccess, logoutSuccess } from "./user.action";
...
export class UserEffect {
    constructor(private authService: AuthService, private actions$: Actions, private store: Store<User>, private router: Router) {}
    _login = createEffect(() => {
